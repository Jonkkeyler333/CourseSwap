...
public class MateriaService {
    ...
    public Materia getByCodigo(String codigo) {
        ...
        return materiaRepository.findByCodigo(normalizedCodigo)
                .orElseThrow(() -> new IllegalArgumentException("No existe una materia con código: " + normalizedCodigo));
    }
    ...
    public List<Materia> searchByNombre(String nombre) {
        ...
        if (materias.isEmpty()) {
            throw new IllegalArgumentException("No se encontraron materias para el nombre: " + normalizedNombre);
        }
        return materias;
    }
    ...
    public List<HorarioResponseDTO> getMateriaHorarioByCodigo(String codigo) {
        ...
        if (horarios.isEmpty()) {
            throw new IllegalArgumentException("No se encontró horario para la materia con código: " + normalizedCodigo);
        }
        return horarios;
    }
